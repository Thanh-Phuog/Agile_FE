...
interface ICategoryRepo {
    getAll(data: CategoryModel): Promise<BaseApiResponseModel<CategoryModel>>;
    ...
    getList(data: CategoryModel): Promise<BaseApiResponseModel<CategoryModel>>;
}
...
export class CategoryRepo implements ICategoryRepo {
    ...
    async getList(data: CategoryModel): Promise<BaseApiResponseModel<CategoryModel>> {
        return client.post(ApiPath.CATEGORY_LIST, data);
    }
}